...
/*   Updated: 2022/07/07 15:34:28 by hyeo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		init_my_struct(t_push_swap *ps_a, t_push_swap *ps_b,
...
void		push_from_stack_b_less_than_20(int *half, t_push_swap *ps_a,
				t_push_swap *ps_b);
int			find_minimum_ra_rra_100(int target, t_push_swap *ps);
int			find_minimum_ra_rra_500(int target, t_push_swap *ps);
void		single_chunk_ra(int *half_array, int target,
				t_push_swap *ps_a, t_push_swap *ps_b);
void		push_from_stack_b(int *half, t_push_swap *ps_a, t_push_swap *ps_b);
void		push_swap_single_chunk(int *my_array, t_push_swap *ps_a,
				t_push_swap *ps_b);
